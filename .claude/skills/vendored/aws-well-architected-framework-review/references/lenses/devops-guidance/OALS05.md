...
In many organizations, this team takes the form of the *Center of
Enablement*. While this centralized team is not strictly required for every
...
centralized governance and an internal service provider consulting partner](https://docs.aws.amazon.com/wellarchitected/latest/operational-excellence-pillar/separated-aeo-ieo-with-cent-gov-and-partner.html)
