...
between finance and technology](https://docs.aws.amazon.com/wellarchitected/latest/cost-optimization-pillar/cost_cloud_financial_management_partnership.html)
- [AWS Cloud Adoption Framework: People Perspective - Transformational
leadership](https://docs.aws.amazon.com/whitepapers/latest/aws-caf-people-perspective/transformational-leadership.html)
- [A Conversation with Werner
Vogels: Learning from the Amazon technology platform](https://queue.acm.org/detail.cfm?id=1142065)
