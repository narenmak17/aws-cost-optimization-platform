...
systematic approach to this process, we follow the [DMAIC](https://www.isixsigma.com/dictionary/dmaic/)—Define, Measure, Analyze,
...
indicators (KPIs) to measure workload performance](https://docs.aws.amazon.com/wellarchitected/latest/performance-efficiency-pillar/perf_monitor_instances_post_launch_establish_kpi.html)
- [AWS Well-Architected Cost Optimization Pillar: COST02-BP02 Implement goals and
targets](https://docs.aws.amazon.com/wellarchitected/latest/cost-optimization-pillar/cost_govern_usage_goal_target.html)
