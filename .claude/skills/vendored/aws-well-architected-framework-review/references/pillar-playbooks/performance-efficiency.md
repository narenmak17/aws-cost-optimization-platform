...
When aws-well-architected-framework-review is scoped to the Performance Efficiency pillar, apply these specialized discovery steps in addition to general infrastructure discovery.
